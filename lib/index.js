...
if (canRun) {
    ...
    console.log(`The buildConfigsDir directory is stated as '${options.buildConfigsDir}'`);
    options._myRoot = resolveDirectory(options.buildConfigsDir);
    console.log(`The buildConfigsDir directory has been set to '${options._myRoot}'`);
