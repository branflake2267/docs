...
class Base {
    ...
    prependHrefPath (tree, pathPrefix) {
        ...
        Utils.each(tree, function (item) {
            ...
            if ((item.href && !item.children) || (item.href && item.type === 'singleton')) {
                ...
                if (item.preparedHref.substr(item.preparedHref.length - 5) !== '.html') {
    ...
    decorateExamples (str) {
        let me = this,
            fiddleWrap = '<div class="da-inline-code-wrap da-inline-code-wrap-fiddle invisible example-collapse-target" id="{2}">' +
                    '<div class="da-inline-fiddle-nav">' +
                        '<div class="code-controls"><span class="collapse-tool"></span><span class="expand-tool"></span><span class="expand-code">Expand Fiddle<span></div>' +
                        ...
                        '<span class="da-inline-fiddle-nav-fiddle">' +
                            ...
                            '</span>' +
                        'Fiddle</span>' +
                        '<span class="fiddle-code-beautify" data-beautify="Beautify Code"><div></div></span>' +
                    '</div>' +
        ...
        out = out.replace(/(?:<pre><code>)/g, '<div class="code-controls example-collapse-target"><span class="collapse-tool"></span><span class="expand-tool"></span>Sample Code</div><pre><code class="language-javascript">');
