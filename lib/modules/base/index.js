...
class Base {
    ...
    createIndexPage (view) {
        ...
        fsextra.copy('./product-templates/images', path.join(dest, 'home-images'), function (err) {
            fs.chmodSync(path.join(dest, 'home-images'), '0755');
        });

        fsextra.copy(__dirname + '/css/fonts', path.join(dest, 'css', 'fonts'), function (err) {
