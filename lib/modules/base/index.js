...
class Base {
    ...
    constructor (options) {
        ...
        // config file options
        let me = this,
            defaultOptions = Object.assign({}, me.defaultOptions),
        ...
        me.options = Object.assign(baseOptions, options);
        ...
        if (parser == 'JsonParser') {
            //me.createLinkMap(options.input, path.join(options.destination, options.pversion));
        }

        me.numberVer = me.getProductVersion(options.pversion);
    }
    ...
    reconcileRepos(options, cleanup) {
        let me = this,
            projects = JSON.parse(fs.readFileSync(__dirname + '/../../configs/projectConfigs.json', 'utf8'))['products'],
            ...
            projects.forEach(function (project) {
                project.versions.forEach(function (pversion) {
                    if (pversion.version == pver) {
                        ...
                        me.log('info', "Checking for sencha documentation repo" );
                        ...
                        me.log('info', "Changing Directories to sencha-documentation");
    ...
    beforeExecute () {
        ...
        me.projectConfigs = projectConfigs;
        me.hasVersions    = hasVersions;
