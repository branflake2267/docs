...
class Base {
    ...
    get outputProductDir () {
        ...
        let { options }     = this,
            ...
            relPrefix       = Path.relative(this.options._execRoot, options._myRoot);
        ...
        console.log("~~~~~ outputProductDir=" + p + " relPrefix=" + relPrefix + " outPath=" + outPath + " execRoot=" + this.options._execRoot);
