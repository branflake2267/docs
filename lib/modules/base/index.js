...
class Base {
    ...
    decorateExamples (str) {
        ...
        out = out.replace(/(?:<pre><code>)/g, '<div class="code-controls example-collapse-target"><span class="collapse-tool"></span><span class="expand-tool"></span>Sample Code</div><pre><code>');
