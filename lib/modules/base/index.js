...
class Base {
    ...
    decorateExamples (str) {
        let me = this,
            fiddleWrap = '<div class="da-inline-code-wrap da-inline-code-wrap-fiddle invisible" id="{2}">' +
                '<div class="code-controls"><span class="collapse-code">Collapse Examples</span><span class="expand-code">Expand Examples<span></div>' +
        ...
        out = out.replace(/(?:<pre><code>)/, '<pre><div class="code-controls"><span class="collapse-code">Collapse Examples</span><span class="expand-code">Expand Examples<span></div><code>');
