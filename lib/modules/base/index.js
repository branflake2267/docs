...
class Base {
    ...
    decorateExamples (str) {
        let me = this,
            fiddleWrap = '<div class="code-controls"><span class="collapse-code">Collapse Examples</span><span class="expand-code">Expand Examples<span></div>' +
                '<div class="da-inline-code-wrap da-inline-code-wrap-fiddle invisible" id="{2}">' +
