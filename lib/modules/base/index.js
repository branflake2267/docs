    ...
    /*prependHrefPath (tree, pathPrefix) {
        ...
        Utils.each(tree, function (item) {
            ...
            if ((item.href && !item.children) || (item.href && item.type === 'singleton') || (item.href=== '')) {
                ...
                myPath = path.relative(pathPrefix, item.pathPrefix || me.productDir);
                ...
                if ((item.preparedHref.substr(item.preparedHref.length - 5) !== '.html') && item.href != '') {
                    if (item.name === 'Sample Login App') {
                        //console.log(path.relative(pathPrefix, item.href));
                    ...
                    if (item.name === 'Button') {
                        ...
                        //console.log(item.href);
                        //console.log(path.relative(pathPrefix, item.href));
                        console.log(item.pathPrefix, pathPrefix);
                        console.log(path.relative(me.productDir, pathPrefix));
                    }
