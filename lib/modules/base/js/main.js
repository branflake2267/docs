(function() {
   ...
   function toggleExamples (collapse) {
    ...
    if (hasClassTemplate) {
        ...
        ExtL.each([].slice.call(document.getElementsByClassName('collapse-code')), function (btn) {
            btn.onclick = onToggleExamplesClick;
        });
        ExtL.each([].slice.call(document.getElementsByClassName('expand-code')), function (btn) {
            btn.onclick = onToggleExamplesClick;
        });
