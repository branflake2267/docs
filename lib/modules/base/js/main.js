(function() {
    ...
    function onToggleExampleClick (e) {
        ...
        if (ExtL.hasCls(target, 'da-inline-fiddle-nav') && !ExtL.hasCls(targetEl, 'example-collapsed')) {
            return;
        }
        console.log('about to collapse / expand');
   ...
   function toggleExamples (collapse) {
    ...
    function initEventHandlers() {
        ...
        //ExtL.each(ExtL.fromNodeList(document.getElementsByClassName('da-inline-fiddle-nav')), function (btn) {
