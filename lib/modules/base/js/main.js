(function() {
    var hasClassTemplate = window.isClassTemplate || false,
        ...
        masterSearchList, apiSearchRecords, guideSearchRecords, currentApiPage, currentGuidePage, eventsEl, resizeTimer, clicked;
   ...
   function toggleExamples (collapse) {
        ...
        ExtL[doCollapse ? 'addCls' : 'removeCls'](body, collapseCls);
    }
    ...
    // expand all examples - collapse all examples
    ExtL.each(ExtL.fromNodeList(document.getElementsByClassName('collapse-code')), function (btn) {
        btn.onclick = onToggleExamplesClick;
    });
    ExtL.each(ExtL.fromNodeList(document.getElementsByClassName('expand-code')), function (btn) {
        btn.onclick = onToggleExamplesClick;
    });
    ...
    function fetchState(skipSave, returnOnly) {
        ...
        ExtL.toggleCls(body, 'collapse-code-all', state.collapseExamples);
