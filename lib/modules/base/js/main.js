(function() {
    ...
    function onBodyClick (e) {
        ...
        if (e) {
            ...
            if (!ExtL.hasCls(target, 'overSelect') && !ExtL.hasCls(target, 'accessCheckbox') && ExtL.get('checkboxes')) {
                ExtL.get('checkboxes').style.display = 'none';
                cbexpanded = false;
            }
    ...
    function onToggleAllClick(e) {
        ...
        ExtL.each(memberList, function (item) {
            //ExtL.removeCls(item, 'temp-show');
            ExtL.toggleCls(item, 'member-expanded');
        });

        (symbText.innerText == '+') ? symbText.innerText = '-' : symbText.innerText = '+';
    }
    ...
    if (hasClassTemplate) {
        ...
        // show / hide access checkboxes
        ExtL.get('cbSelectBox').onclick = onCbSelectBoxClick;
