(function() {
    ...
    function onApiTabClick (e) {
        ...
        if (!ExtL.hasCls(target, 'active-tab')) {
            ...
            //window.location.href = homePath + (product === 'test' ? 'ST.html' : 'Ext.html');
        }
    }
    ...
    function searchFilter (e){
        var results = [],
            ...
            filterClassic, filterModern, classObj;
        ...
        if (hasApi) {
            ...
            rx = new RegExp('(\\d+\\D?)(?:-)([$a-zA-Z0-9\\.\-]*' + value + '[a-zA-Z0-9\\.\-]*)(?:`)', 'gi');
    ...
    function filterSearchByToolkit (e) {
        ...
        if (ExtL.isString(e)) {
            ...
            if (ExtL.hasCls(mButton, 'active') && ExtL.hasCls(cButton, 'active')) {
                ...
                //ExtL.toggleCls(mButton, 'active');
                //ExtL.toggleCls(cButton, 'active');
            }
        }
    ...
    function loadApiSearchPage (page) {
        ...
        for (;i < pageSize; i++) {
            ...
            if (rec) {
                ...
                //href = rel + href;
                href = homePath + rec.classObj.t + '/' + href;
    ...
    function runFiddleExample (wrap) {
        var editor  = ace.edit(wrap.querySelector('.ace-ct').id),
            ...
            toolkit = (myToolkit && dash) ? myToolkit : false,
            codes   = [
                {
                    type : 'js',
                    name : 'app.js',
        ...
        if (myToolkit === 'modern') {
            ...
            console.log(data.codes.codes[0].code);
        }

        if (pageName.indexOf('.ux.') > -1) {
        ...
        } else if (pageName.indexOf('.calendar.') > -1) {
            data.codes.codes = data.codes.codes.concat([{
                type : 'js',
