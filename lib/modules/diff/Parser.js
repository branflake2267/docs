...
Parser.prototype.initCount = function(type) {
    this[type + 'Count'] = {
        added    : 0,
        modified : 0,
        remoevd  : 0
...
Parser.prototype.addChangeCount = function(type, action) {
    var obj = this[type + 'Count'];
            ...
            if (newMatch.ignore) {
                ...
                if (newMatch.name) {
                    ...
                    if (changes) {
                        ...
                        me.addChangeCount(type, changes.action);
