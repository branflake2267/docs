...
class Guide extends Base {
    ...
    run () {
        ...
        fs.writeFileSync(me.destination + 'js/guideSearch.js', 'var guideSearchWords = ' + JSON.stringify(me.searchWords) + ';var guideSearchRef = ' + JSON.stringify(me.searchRef) + ';var guideSearchUrls = ' + JSON.stringify(me.searchUrls) + ';', 'utf-8');
    ...
    parseNode (node, versions) {
        ...
        if (!target || target === 'html') {
            ...
            me.searchUrls.push(pathPrefix + node.id.replace('_-_', '/'));
