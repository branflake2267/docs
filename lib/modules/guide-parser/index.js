...
class Guide extends Base {
    ...
    run () {
        ...
        //stringfiedTree = JSON.stringify(guideJsonObj.tree, null, me.compress ? 0 : 4);
        ...
        //let search = me.getSearch();

        //
        /*let cmdOptions = Object.assign({}, me.options);
        cmdOptions = Object.assign(cmdOptions, {
            config: 'cmd',
            pversion: '6.x'
        });
        let cmdSearch = new Guide(cmdOptions).getSearch();
        console.log(cmdSearch);*/
        //


        /*fs.writeFileSync(homedest + 'js/guideSearch.js', 'var guideSearchWords = ' + JSON.stringify(search.searchWords) + ';var guideSearchRef = ' + JSON.stringify(search.searchRef) + ';var guideSearchUrls = ' + JSON.stringify(search.searchUrls) + ';', 'utf-8');*/
