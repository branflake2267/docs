        ...
        if (classNames && classNames.length) {
            ...
            Utils.each(classNames, function(name) {
                ...
                view = {
                    ...
                    //fileName          : './src/' + me.headerLink.link[0] + (me.headerLink.class ? '#' + me.headerLink.class : ''),
        ...
        if (!me.headerLink && obj.files.length) {
            ...
            for (let i = 0, len = files.length; i < len; i++) {
                ...
                if (shortName === fileName) {
                    //src.push(file);
                    //'./src/' + me.headerLink.link[0] + (me.headerLink.class ? '#' + me.headerLink.class : ''),
            ...
            //me.headerLink = me.parseLink(obj.files[0], name);
