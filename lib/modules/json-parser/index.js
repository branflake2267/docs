...
class JsonParser extends ClassTree {
    ...
    beforeExecute (fileArray) {
        ...
        new compressor.minify({
            ...
            fileOut : this.destination + this.version + '/js/app.js'
        });
    }
    ...
    parser (datas, outputDir) {
        ...
        me.destination = path.join(me.destination, version) + '/';
        ...
        if (datas && datas.length) {
            ...
            datas.forEach(function(data, idx) {
                ...
                if (cls.$type === 'enum') {
                    memberTypeGroups.forEach(function (grp) {
                        if (grp.$type === 'properties') {
                            ...
                            //console.log(cls.name, grp.items[0]);
                ...
                view = {
                    ...
                    extends           : cls.extended            ? me.splitInline(me.processExtends(cls.extended, true), '<br>')  : '',
                    extenders         : cls.extenders           ? me.splitInline(me.processExtends(cls.extenders, true), '<br>') : '',
                    mixers            : cls.mixers              ? me.splitInline(me.processExtends(cls.mixers, true), '<br>')    : '',
                    aliasName         : aliasName,
                    classAlias        : alias,
