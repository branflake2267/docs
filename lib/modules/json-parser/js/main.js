(function() {
    ...
    function tabChange() {
        var clickId  = this.id,
            apiTab   = ExtL.get('tree'),
            guideTab = ExtL.get('guide-tree');

        ExtL.removeCls(apiTab, 'show');
        ExtL.removeCls(guideTab, 'show');

        if(clickId == 'apiTab') {
            ExtL.addCls(guideTab, 'hide');
            ExtL.addCls(apiTab, 'show');
        }else {
            ExtL.addCls(apiTab, 'hide');
            ExtL.addCls(guideTab, 'show');
        }
        return false;
    }
    ...
    if (hasClassTemplate) {
        ...
        getMemberTypeMenu().onmousewheel = wheelHandler;wheelHandler;
