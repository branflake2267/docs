(function() {
    ...
    function initMemberTypeMouseoverHandlers() {
        ...
        for (; i < len; i++) {
            ...
            addMouseEventsToItem(btns.item(i), 'mouseleave', false);
            addMouseEventsToItem(btns.item(i), 'click', false, hideMemberTypeMenu);
    ...
    function addMouseEventsToItem(item, event, menuCanClose, fn) {
