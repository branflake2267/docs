(function() {
    ...
    if (hasClassTemplate) {
        ...
        ExtL.get('box').onkeypress = ExtL.createBuffered(filter, 200);
    }
    ...
    ExtL.get('mobile-input').oninput = searchFilter;
    ExtL.get('mobile-input').onkeypress = onSearchKeypress;
    ...
    function showMemberTypeMenu (e) {
        ...
        ExtL.each(memberList, function (item) {
            ...
            if (item.offsetParent) {
                ...
                memberObj = {
                    ...
                    title: ExtL.trim(link.textContent),
        ...
        if (targetId === 'methods' || targetId === 'properties') {
            eligMembers.sort(function (a, b) {
                var aStr = ExtL.trim(a.firstChild.textContent),
                    bStr = ExtL.trim(b.firstChild.textContent);
