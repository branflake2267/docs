(function() {
    ...
    function getMemberTypeMenu () {
        ...
        if (!menu) {
            ...
            addMouseEventsToItem(menu, 'mouseenter', false);
            addMouseEventsToItem(menu, 'mouseleave', true);
    ...
    function showMemberTypeMenu (e) {
        var menu = getMemberTypeMenu(),
            ...
            cols = [],
            tallest = 0,
            target, targetBox, targetId, targetCt, height, memberList, configsCt, rows, maxCols, 
            maxLiteralWidth, useMembersWidth, width, left, colCount, rowCount, j, col, explicitAccessors;
    ...
    function initMemberTypeMouseoverHandlers() {
        ...
        for (; i < len; i++) {
            addMouseEventsToItem(btns.item(i), 'mouseenter', false);
            addMouseEventsToItem(btns.item(i), 'mouseleave', true);
            addMouseEventsToItem(btns.item(i), 'click', true, hideMemberTypeMenu);
    ...
    function addMouseEventsToItem(item, event, menuClose, fn) {
