...
window.onscroll = function(e) {
    var vertical_position = 0,
        treex             = document.getElementById('tree'),
        headheight        = document.getElementsByClassName('classHead')[0].clientHeight + 65;
    ...
    if (vertical_position > headheight) {
        treex.style.top = (60) + 'px';
    } else {
        treex.style.top = (headheight + 70) + 'px';
    }
};
