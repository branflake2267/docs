                ...
                types.forEach(function(type) {
                    ...
                    if (members) {
                        members.forEach(function(member) {
                            me.addCount(cls.name, type.$type, true);
                        });
                    } else {
...
Info.prototype.addCount = function(name, type, count) {
    var me     = this,
        map    = me.map,
        totals = me.totals,
        obj    = map[name],
...
Info.prototype.output = function(target) {
    ...
    for (name in totals) {
        output.push(' - ' + Utils.formatNumber(totals[name]) + ' total ' + name.replace(totalEndRe, ''));
    }
