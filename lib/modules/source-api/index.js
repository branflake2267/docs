...
class SourceApi extends Base {
    ...
    doListMissingExamples (prepared, componentsOnly) {
        ...
        if (text && !text.includes('@example')) {
            if (!componentsOnly || (componentsOnly && extendsList && extendsList.split(',')[0].includes('Ext.Component'))) {
                this.log('MISSING EXAMPLE', prepared.name);
            }
        }
    }
    ...
    doListLackingDescription (prepared) {
        ...
        if (!text || (text && text.length < 80)) {
            this.log('LACKING DESCRIPTION', prepared.name);
        }
    }
    ...
    createSrcFiles () {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.log('createSrcFiles: Started.');
            ...
            this.log("createSrcFiles: middle 1");
            ...
            this.log("createSrcFiles: middle 2");
        ...
        this.log("createSrcFiles: Finished");
    }
    ...
    outputSrcFiles (contents) {
        return new Promise((resolve, reject) => {
            ...
            Fs.ensureDir(outDir, () => {
                ...
                this.log('OUTPUT SOURCE FILES IS DONE !!!');
