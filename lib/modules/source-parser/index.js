...
class Source extends Base {
    get defaultOptions () {
        return {
            ...
            localSpace: '/var/www/sites/SpaceSDK/src/'
        };
    }
    ...
    run () {
        let me          = this,
            ...
            localSDK    = configs.localSDK   || options.localSDK,
            localPrim   = configs.localPrim  || options.localPrim,
            localPkg    = configs.localPkg   || options.localPkg,
            localSpace  = configs.localSpace || options.localSpace,
        ...
        console.log(localSDK + '../docs/resources');
