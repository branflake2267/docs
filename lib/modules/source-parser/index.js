    ...
    run () {
        ...
        if (fs.existsSync('./configs/basePaths.json')) {
            ...
            let basePaths = JSON.parse(fs.readFileSync('./configs/basePaths.json', 'utf-8')),
                localPrim = basePaths.localPrim || me.localPrim,
                localSDK  = (basePaths.localSDK + basePaths.extFolder) || me.localSDK,
                localPkg  = (basePaths.localSDK + basePaths.pkgFolder) || me.localPkg;
