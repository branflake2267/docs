...
class Source extends Base {
    ...
    run () {
        let me = this,
            ...
            basePaths = JSON.parse(fs.readFileSync(me.basePaths, 'utf-8')),
            output = me.destination,
            ...
            localSpace = basePaths.localSpace || me.localSpace,
            //allCls = (me.allClasses) ? JSON.parse(fs.readFileSync(me.input + me.allClasses, 'utf-8')) : null,
            //allCls = (me.allClasses) ? require('../../' + me.input + me.allClasses) : null,
            allCls = require('../../' + me.input + me.allClasses),
            srcOutput = output + 'src/',
            //files = (allCls) ? allCls.files : null,
            files = allCls.files,
