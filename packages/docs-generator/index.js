...
const args = require('yargs')
    .option({
        ...
        buildConfigsDir : {
          ...
          example     : 'node --max-old-space-size=4076 index create-app-html runGuides --buildConfigsDir=~/build-config-sencha --product=extjs --version=6.2.1 --cmdPath=../../sencha_cmd/sencha'
      },
